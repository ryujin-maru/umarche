        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <form method="post" action="{{ route('owner.product.update',['product' => $product->id])}}" >
                      @csrf
                      <div class="-m-2">
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
                            ...
                            <input type="hidden" id="currrent_quantity" name="current_quantity" value="{{ $quantity }}" required >
                        ...
                        <x-select-image :images="$images" name="image1" currectId="{{$product->image1}}" currentImage="{{$product->imageFirst->filename ?? ''}}" />
                        <x-select-image :images="$images" name="image2" currectId="{{$product->image2}}" currentImage="{{$product->imageSecond->filename ?? ''}}"/>
                        <x-select-image :images="$images" name="image3" currectId="{{$product->image3}}" currentImage="{{$product->imageThird->filename ?? ''}}"/>
                        <x-select-image :images="$images" name="image4" currectId="{{$product->image4}}" currentImage="{{$product->imageFourth->filename ?? ''}}"/>
