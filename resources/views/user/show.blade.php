                    ...
                    <div class="border-t border-gray-400 my-8">
                        ...
                        <div class="mb-4 text-center">
                            @if ($product->shop->filename !== null)
                                <img class="w-40 h-40 rounded-full mx-auto object-cover" src="{{ asset('storage/products/' . $product->imageFirst->filename )}}">
                                @else
                                <img src="">
                            @endif
                        </div>
                        <div class="mb-4 text-center">
                            <button type="button" data-micromodal-trigger="modal-1" href='javascript:;' class="flex ml-auto text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                        </div>
                    </div>
                </div>
            </div>
